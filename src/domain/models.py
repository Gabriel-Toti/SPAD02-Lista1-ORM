...
class Orders(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['customerid'], ['northwind.customers.customerid'], name='customers_fkey'),
        ForeignKeyConstraint(['employeeid'], ['northwind.employees.employeeid'], name='employees_fkey'),
...
class OrderDetails(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['orderid'], ['northwind.orders.orderid'], name='orders_fkey'),
        ForeignKeyConstraint(['productid'], ['northwind.products.productid'], name='products_fkey'),
